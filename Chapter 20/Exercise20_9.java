 ...
 * 05/01/21
 *
 * Modify to assign a random radius between 2 and 20 when a ball is created.
 * When the - button is clicked, one of the largest balls is removed.
 */
